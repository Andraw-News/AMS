                ...
                <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="row align-items-center">
                                    <div class="col-2">
                                        <i class="mdi mdi-cake font-20 text-danger"></i>
                                    </div>
                                    <div class="col-10">
                                        <h4 class="card-title">Birthday Celebrants this <?php echo date('M');?></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="comment-widgets scrollable" style="height:430px;">
                                <!-- Comment Row -->
                                <?php $action->getBdayCelebs();?>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-7">
                                        ...
                                        <p class="font-16 m-b-5">Sign Ups</p>
                                    </div>
                                    <div class="col-5">
                                        <h1 class="font-light text-right mb-0"><?php echo $action->getTotalSignups();?></h1>
                                    </div>
                                </div>
                            </div>
                        </div>                        
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-7">
                                        ...
                                        <p class="font-16 m-b-5">Alumnis</p>
                                    </div>
                                    <div class="col-5">
                                        <h1 class="font-light text-right mb-0"><?php echo $action->getTotalAlumni(); ?></h1>
                                    </div>
                                </div>
                            </div>
                        </div>
